...
# CSV 파일 읽기 (인코딩 문제 해결)
try:
    df = pd.read_csv('한국남동발전_시간대별_풍력_발전실적_찐찐막.csv', encoding='utf-8')
except UnicodeDecodeError:
    try:
        df = pd.read_csv('한국남동발전_시간대별_풍력_발전실적_찐찐막.csv', encoding='cp949')
    except UnicodeDecodeError:
        df = pd.read_csv('한국남동발전_시간대별_풍력_발전실적_찐찐막.csv', encoding='utf-8-sig')
...
# 새로운 CSV 파일로 저장
new_df.to_csv('한국남동발전_시간대별_풍력_발전실적_재구성_찐찐막.csv', index=False, encoding='utf-8-sig')
print("\n파일이 '한국남동발전_시간대별_풍력_발전실적_재구성_찐찐막.csv'로 저장되었습니다.")
